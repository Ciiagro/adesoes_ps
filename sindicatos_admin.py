...
_RELATORIO_COLS = [55 * mm, 60 * mm, 35 * mm, 95 * mm]
...
def _relatorio_tabela_contatos(sindicatos_dict):
    dados = [[
        Paragraph("SINDICATO", _ficha_cabecalho_style),
    ...
    for nome_sindicato in sorted(sindicatos_dict.keys()):
        info = sindicatos_dict[nome_sindicato]
        dados.append([
            Paragraph(nome_sindicato, _ficha_sindicato_style),
            Paragraph(info["presidente"] or "—", _ficha_municipios_style),
